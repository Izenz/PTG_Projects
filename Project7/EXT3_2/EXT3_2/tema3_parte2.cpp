...
bool init()
{
	...
	// Localización del ID de las variables uniform
...
void display()
{
	...
	struct LightInfo {
	 glm::vec4 lightPos; // posición de la luz
	 glm::vec3 intensity;
	 glm::vec3 k;
	 glm::vec3 dir; // dirección del foco
	 GLfloat cutOffInt; // ángulo interior (ángulo límite de la zona iluminada)
	 GLfloat cutOffExt; // ángulo exterior (ángulo límite de la zona de penumbra)
	};
	...
	glm::vec4 lpos = mv * light.lightPos;	// Posición de la luz puntual/foco en el S.R. vista
	glm::vec3 ldir = nm * light.dir;		// Dirección del foco en el S.R. vista
